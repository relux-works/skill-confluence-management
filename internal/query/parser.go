// DSL parser for Confluence agent-facing queries.
// Tokenizer copied from jira-management (domain-agnostic).
// Operations and field definitions adapted for Confluence.
//
// Grammar:
//   batch     = query (";" query)*
...
type Statement struct {
	Operation string   // e.g. "get", "list", "search", "children", "ancestors", "spaces", "tree", "history"
...
// --- Tokenizer (domain-agnostic, from jira-management) ---
...
// ValidOperations defines recognized DSL operations for Confluence.
var ValidOperations = map[string]bool{
	"get":       true, // get page by ID or by space+title
	"list":      true, // list pages in space
	"search":    true, // CQL search
	"children":  true, // direct children of a page
	"ancestors": true, // breadcrumb chain
	"tree":      true, // recursive children
	"spaces":    true, // list spaces
	"history":   true, // version history
}
...
// --- Field definitions (Confluence-specific) ---

// ValidFields defines all recognized field names for Confluence pages.
